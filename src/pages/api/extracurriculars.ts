...
export const extracurriculars: Extracurricular[] = [
    {
        ...
        description:
            "Advising YBI portfolio companies on MVP strategy, scope, and execution. Led the YBI's MVP Development Program (2023-2025), which funded and delivered student-developed MVPs for Northeast Ohio startups.",
    },
    {
