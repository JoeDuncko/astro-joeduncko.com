...
Not engineering velocity. Product velocity.
...
Teams can make smaller bets, ship rougher ideas, gather feedback quickly, and adjust course. Work that doesn’t make the cut can be discarded without much concern because the learning was worth more than the implementation cost.
...
If customer feedback takes months, implementation becomes more conservative because teams know they may not get another meaningful chance to adjust soon.

If approvals and coordination take weeks, releases become larger because organizations try to maximize the value of each expensive iteration. But larger releases create larger QA surfaces, generate broader feedback, and increase the amount of rework required when feedback inevitably arrives.
...
Long implementation cycles create pressure for larger releases. Larger releases create broader feedback and more QA overhead. More QA and coordination slow down rollout and validation. Slower validation increases the pressure to “get it right” before shipping. So planning expands further.
...
Implementation was expensive. Engineering time was scarce. Reworking the wrong solution carried enormous cost. So organizations evolved processes designed to de-risk implementation as much as possible before writing code.
