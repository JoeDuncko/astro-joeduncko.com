...
And once iteration becomes expensive, organizations naturally rely more heavily on prediction and coordination to avoid costly mistakes.
...
Because if the cost of iteration has dropped, organizations can rely more on rapid adaptation and less on predictive overhead.
