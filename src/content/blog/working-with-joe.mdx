...
Hi, I'm **Joe Duncko**, and I currently lead engineering efforts at **BlastPoint** and **Dev Youngstown**.

-   **At BlastPoint**: I coordinate the **Platform Team's** workload, process, and growth. My responsibilities span **product, people, and planning**—ensuring we're building high-quality software at the right pace.
-   **At Dev Youngstown**: I **work with YBI clients** to define their business goals and scope software solutions. I then coordinate work with student developers to ensure **high-quality deliverables**.
...
-   **Meetings dominate my week.** Every other Monday are 1:1s, every other Wednesday is cycle planning, and most other days fill up quick as I coordinate existing and new work. On Fridays I usually fit in some **Dev Youngstown** work.
...
-   **Meetings are crutches for poor communication and process gaps.**
-   We should **eliminate unnecessary meetings** whenever possible. If a meeting isn't adding value, let's discuss whether we can replace it with async updates.
-   There are two types of meetings:
    1. **Meetings that force us to do the work** (e.g., updating a status board).
    2. **Meetings that force us to communicate** (e.g., 1:1s, retros).
