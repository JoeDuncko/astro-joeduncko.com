...
On the side I **work with [Youngstown Business Incubator (YBI)](https://ybi.org/) clients** to help them navigate the software development life cycle. Until recently, I also ran the YBI's MVP Development Program, where I worked with a team of talented student software developers via [Dev Youngstown](https://www.youngstown.dev/), my consulting arm, to scope and build MVPs for portfolio companies.
...
- **I delegate as much as possible**, especially vague and unstructured work. Unstructured work on my plate tends to get blocked or delayed because of my meeting load. Please let me know if work I've delegated needs clearer requirements, and we can figure them out together.
...
- **Use the "Blocked" word carefully.** If you tell me you're blocked, I will **immediately** prioritize getting you unstuck.
...
- I almost always have a fidget toy in my hands while meeting.
- Music helps me focus - if we are in person, please don't hesitate to tap me on the shoulder to get my attention.

### Favorite Non-Work Topics

- **Startups, hackathons, frontend development**: I have a failed startup under my belt, started [Youngstown State University's hackathon](https://hackysu.com/), and have written a lot of React.
