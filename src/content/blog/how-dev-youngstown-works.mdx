...
Starting in 2023, the YBI funds one MVP per quarter, with a typical total budget ranging from $10,000 to $20,000. This grant funds typically must matched by the startup, ensuring that the startup has "skin in the game".
